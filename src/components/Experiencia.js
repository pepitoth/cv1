...
export default function experiencia() {
  return (
    ...
    <div className='data_Frame'>
        ...
        <div className='data_R'>
          <ul>  Valle maule S.A <br/>
          funciones: <li className='listas'>Digitador de ingreso de frutsa encargado de turno de noche</li>
          <li className='listas'>Preparacion de informes de productos enviados y por despachar segun excel acumulado</li>  
          </ul>
        </div>    
    </div>
    ...
    <div className='data_Frame'>
        ...
        <div className='data_R'>
          <ul>  Ayudante de albañil <br/>
          funciones: <li className='listas'>Asistencia a albañiles en obra</li>
          </ul>
        </div>    
    </div>
